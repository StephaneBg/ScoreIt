...
public class FloatingActionButton extends ImageView {
    ...
    private TouchAnimationListener mAnimationListener;
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray styles = context.obtainStyledAttributes(attrs, R.styleable.FloatingActionButton, 0, 0);
        mFabAttachTo = styles.getResourceId(R.styleable.FloatingActionButton_fab_attachTo, 0);
        mFabAttachAt = styles.getInt(R.styleable.FloatingActionButton_fab_attachAt, TOP_RIGHT);
        mFabSize = styles.getInt(R.styleable.FloatingActionButton_fab_size, NORMAL);
        mFabAttachPadding = (int) styles.getDimension(R.styleable.FloatingActionButton_fab_padding, 16 * density);
        mFabRevealAfterMs = styles.getInteger(R.styleable.FloatingActionButton_fab_revealAfterMs, -1);
        styles.recycle();
    ...
    public void setTouchAnimationListener(TouchAnimationListener animationListener) {
